 ...
 */
final class Version20250127213903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE juego ADD tipo VARCHAR(10) NOT NULL, DROP juego_base_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE juego ADD juego_base_id INT DEFAULT NULL, DROP tipo');
