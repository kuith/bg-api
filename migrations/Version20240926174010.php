 ...
 */
final class Version20240926174010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE expansion (id INT AUTO_INCREMENT NOT NULL, juego_id INT NOT NULL, nombre VARCHAR(255) NOT NULL, INDEX IDX_F0695B7213375255 (juego_id), UNIQUE INDEX Expansion (nombre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
