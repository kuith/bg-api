 ...
 */
final class Version20241217193232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE juego (id INT AUTO_INCREMENT NOT NULL, juego_base_id INT NOT NULL, nombre VARCHAR(100) NOT NULL, descripcion LONGTEXT NOT NULL, min_jugadores INT NOT NULL, max_jugadores INT NOT NULL, precio DOUBLE PRECISION NOT NULL, disp_automa TINYINT(1) NOT NULL, editorial_madre VARCHAR(255) NOT NULL, editorial_local VARCHAR(255) NOT NULL, tipo VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_F0EC403D3A909126 (nombre), INDEX IDX_F0EC403D6E5E864D (juego_base_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
