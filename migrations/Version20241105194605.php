 ...
 */
final class Version20241105194605 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE autor (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE expansiones (id INT AUTO_INCREMENT NOT NULL, juego_id INT NOT NULL, nombre VARCHAR(100) NOT NULL, descripcion LONGTEXT DEFAULT NULL, fecha_lanzamiento DATE NOT NULL, INDEX IDX_71EFCEFA13375255 (juego_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE expansiones_autores (expansion_id INT NOT NULL, autor_id INT NOT NULL, INDEX IDX_A7C7CB5C5C15249D (expansion_id), INDEX IDX_A7C7CB5C14D45BBE (autor_id), PRIMARY KEY(expansion_id, autor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE juego (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, descripcion LONGTEXT NOT NULL, disp_automa TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_F0EC403D3A909126 (nombre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jugador (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(50) NOT NULL, correo VARCHAR(100) NOT NULL, rol VARCHAR(10) NOT NULL, fecha_registro DATE NOT NULL, UNIQUE INDEX UNIQ_527D6F183A909126 (nombre), UNIQUE INDEX UNIQ_527D6F1877040BC9 (correo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE expansiones ADD CONSTRAINT FK_71EFCEFA13375255 FOREIGN KEY (juego_id) REFERENCES juego (id)');
        $this->addSql('ALTER TABLE expansiones_autores ADD CONSTRAINT FK_A7C7CB5C5C15249D FOREIGN KEY (expansion_id) REFERENCES expansiones (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE expansiones_autores ADD CONSTRAINT FK_A7C7CB5C14D45BBE FOREIGN KEY (autor_id) REFERENCES autor (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE expansiones DROP FOREIGN KEY FK_71EFCEFA13375255');
        $this->addSql('ALTER TABLE expansiones_autores DROP FOREIGN KEY FK_A7C7CB5C5C15249D');
        $this->addSql('ALTER TABLE expansiones_autores DROP FOREIGN KEY FK_A7C7CB5C14D45BBE');
        ...
        $this->addSql('DROP TABLE expansiones');
        $this->addSql('DROP TABLE expansiones_autores');
